          ...
          <Layout style={{ minHeight: '100vh' }}>
            <Sider collapsible collapsed={this.state.collapsed} onCollapse={this.onCollapse}>
              ...
              <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
                ...
                >
                  ...
                  <Menu.Item key="2"><Link to="/False_Position"/>FalsePosition</Menu.Item>
            ...
            <Layout className="site-layout">
                ...
                <Breadcrumb style={{ margin: '16px 0' }}>
                  <Breadcrumb.Item><Title><Text type="warning">NUMERICAL METHODS</Text></Title></Breadcrumb.Item>
 
                </Breadcrumb>
                
                <div className="site-layout-background" style={{ padding: 24, minHeight: 500 }}>
                <div className="box" style={{ padding: 24, minHeight: 500 }}>
                  <h1><font size="10"> WELCOME </font></h1>
                  <img src="nn.jpg" alt="" ></img>
                  <h3>Kanyakorn Jeerachesthanon  (กัลยกร จิรเศรษฐานนท์) <br />
                  5904062616028<br />
                  Computer Science
                  </h3>
