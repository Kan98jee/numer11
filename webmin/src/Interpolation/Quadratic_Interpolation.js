...
export default class Quadratic_Interpolation extends Component{
        ...
        return (
          <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout className="site-layout">
                ...
                <Breadcrumb.Item><Title><Text type="danger">Quadratic Interpolation</Text></Title></Breadcrumb.Item>
