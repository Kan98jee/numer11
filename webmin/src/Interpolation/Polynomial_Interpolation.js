...
export default class Polynomial_Interpolation extends Component{
        ...
        return (
          <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout className="site-layout">
                ...
                <Breadcrumb.Item><Title><Text type="danger">Polynomial Interpolation</Text></Title></Breadcrumb.Item>
